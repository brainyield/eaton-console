      ...
      <form onSubmit={handleSubmit}>
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="period-start" className="block text-xs text-zinc-500 mb-1">Start Date</label>
                <div className="relative">
                  <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500" aria-hidden="true" />
                  <input
                    type="date"
                    id="period-start"
                    value={periodStart}
              ...
              <div>
                <label htmlFor="period-end" className="block text-xs text-zinc-500 mb-1">End Date</label>
                <div className="relative">
                  <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500" aria-hidden="true" />
                  <input
                    type="date"
        ...
        <div className="px-6 py-4">
          <ModalFooter
            ...
            submitText="Generate Payroll Run"
