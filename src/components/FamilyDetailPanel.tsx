...
import { X, Mail, Phone, CreditCard, Calendar, MoreVertical, ChevronRight } from 'lucide-react'
...
export function FamilyDetailPanel({ family, onClose }: FamilyDetailPanelProps) {
  ...
  return (
    <div className="fixed right-0 top-0 h-full w-[480px] bg-zinc-900 border-l border-zinc-800 shadow-2xl flex flex-col z-50">
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800">
        ...
        <div className="flex items-center gap-2">
          <button className="px-3 py-1.5 text-sm text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-md">
            Actions
          </button>
                  ...
                  >
                    <div>
                      ...
                      <div className="text-xs text-zinc-400">
                        {[student.grade_level, student.age_group].filter(Boolean).join(' • ')}
                      </div>
                    </div>
